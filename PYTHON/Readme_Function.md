...
1. Return Type: <The return type specifies the type of value that the function will return. It can be any valid data type such as int, float, char, void, etc. and it used in inside the function
